 ...
 */
public abstract class MagneticOrientationChangeListener {
    private static final String TAG = "MagneticListener";
     ...
     */
    public MagneticOrientationChangeListener(Context context) {
     ...
     */
    public MagneticOrientationChangeListener(Context context, int rate) {
