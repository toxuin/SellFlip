 ...
 */
public class StaggeredGridViewSellFlip extends ExtendableListView {
    ...
    public StaggeredGridViewSellFlip(final Context context) {
        this(context, null);
    }

    public StaggeredGridViewSellFlip(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StaggeredGridViewSellFlip(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    public void nCountPortrait(int columnCountPortrait) {
